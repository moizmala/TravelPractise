        ...
        foreach (string key in FilterFields.Keys)
        {
            ...
            else if (mainControl is CMSDropDownList)
            {
                ...
                if (!String.IsNullOrEmpty(textboxValue))
                {
                    ...
                    string value = SqlHelper.EscapeQuotes(textboxValue);
                    ...
                    {
                        string defaultCondition = String.Format(defaultFormat, columnName, op, likeOperator ? SqlHelper.EscapeLikeText(value) : value);
...
#pragma warning restore 612, 618
    ...
    private bool IsInternalPostBack()
    {
        if (RequestHelper.IsPostBack())
        {
            ...
            if (ControlsHelper.CausedPostBack(FilterPlaceHolder))
            {
                return true;
            }
        }
