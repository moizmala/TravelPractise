...
public static class SharePointFunctions
{
    ...
    public static ICredentials GetSharePointCredetials()
    {
        ...
        else
        {
            ...
            string username = SettingsKeyInfoProvider.GetStringValue(siteName + ".CMSSharePointUserName");
            string pass = EncryptionHelper.DecryptData(SettingsKeyInfoProvider.GetStringValue(siteName + ".CMSSharePointPassword"));
