define(['CMS/EventHub'], function (EventHub) {
    ...
    var MultiFileUploader = function (data) {
        ...
        // Calculates total size of all uplaoded files
        ...
        // Check if all files have allowed extensinon. If no, the function returns first wrong extension
        ...
        uploader.onchange = function (e) {
            ...
            if (extension) {
                alert(formatString(window.MFUResources['multifileuploader.extensionnotallowed'], extension, allowedExtensions.replace(';', ', ')));
                return;
            }
