...
public partial class CMSModules_Content_Controls_Dialogs_Web_WebContentSelector : CMSUserControl
{
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        if (!RequestHelper.IsPostBack())
        {
            ...
            // Set alternate text
            string imgAltClientId = QueryHelper.GetString(DialogParameters.IMG_ALT_CLIENTID, "");
            string scriptAlt = @"if (wopener) {
                                var hdnAlt = wopener.document.getElementById('" + ScriptHelper.GetString(imgAltClientId, false) + @"');
