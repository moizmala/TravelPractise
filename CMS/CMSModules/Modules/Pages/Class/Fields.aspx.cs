    ...
    private void SetupControls()
    {
        ...
        if (dci != null)
        {
            ...
            else
            {
                ...
                bool isEditable = ((resource != null) && resource.IsEditable) || dci.ClassShowAsSystemTable || SystemContext.DevelopmentMode;

                // Allow development mode only for non-system tables
                fieldEditor.DevelopmentMode = !dci.ClassShowAsSystemTable || SystemContext.DevelopmentMode;
