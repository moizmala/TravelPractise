...
public partial class CMSModules_Ecommerce_Controls_ShoppingCart_OrderItemEdit : CMSEcommercePage
{
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        if (ECommerceSettings.EnableOrderItemEditing)
        {
        ...
        else
        {
            ...
            btnSave.Click += (s, ea) => CloseDialogWindow();
        }
    }
    ...
    protected void EditForm_OnBeforeSave(object sender, EventArgs e)
    {
        ...
        if (!ECommerceContext.IsUserAuthorizedForPermission("ModifyOrders") || !ECommerceSettings.EnableOrderItemEditing)
        {
